...
function createProjectPaneProps(
  ...
  const data: ComponentProps<typeof ProjectPane>["data"] = {
    ...
    projectProviderCounts: { claude: 1, codex: 1, gemini: 1, cursor: 0, copilot: 0, opencode: 0 },
      ...
      <ProjectPaneHarness
        overrides={{
          data: {
            ...
            viewMode: "tree",
            updateSource: "auto",
            projectProviderCounts: { claude: 1, codex: 1, gemini: 0, cursor: 0, copilot: 0, opencode: 0 },
